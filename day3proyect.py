...
print(f"The count of '{letters_to_Search[0]}' is {count_of_firstLetter}")
print(f"The count of '{letters_to_Search[1]}' is {count_of_secondLetter}")
print(f"The count of '{letters_to_Search[2]}' is {count_of_thirdLetter}")
